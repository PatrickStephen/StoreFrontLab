...
namespace StoreFrontLab.UI.MVC.Controllers
{
    public class ItemsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ItemID,ItemName,Price,StatusID,Author,CategoryID,ItemImage,Description")] Item item)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ItemID,ItemName,Price,StatusID,Author,CategoryID,ItemImage,Description")] Item item)
        {
            if (ModelState.IsValid)
            {
